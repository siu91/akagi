...
public class AkagiAutoConfigure {
    ...
    @ConditionalOnExpression("'${akagi.security.token-secret-key-mode}'.toLowerCase().equals(T(org.siu.akagi.autoconfigure.AkagiTokenSecretKeyMode).CUSTOM_REDIS.toString().toLowerCase())")
    ...
    public TokenProvider tokenProvider() {
        log.info("初始化-Token Provider:[{}]", this.properties.getTokenSecretKeyMode());
